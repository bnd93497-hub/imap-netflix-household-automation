...
async function startWhatsApp() {
   const mongoClient = new MongoClient("mongodb+srv://bnd93497_db_user:BotAdmin123@cluster1.hxqhlsq.mongodb.net/?retryWrites=true&w=majority&appName=Cluster1&tls=true");
